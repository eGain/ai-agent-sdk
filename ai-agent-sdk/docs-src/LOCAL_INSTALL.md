...
{
  "dependencies": {
    "@eGainDev/ai-agent-sdk": "file:../aiagent-sdk"
  }
}
```
...
- Verify `npm link @eGainDev/ai-agent-sdk` ran successfully in your project
- Check that `dist/` folder exists and has been built

### "Module not found" errors
- Rebuild the SDK: `npm run build`
- Reinstall: `npm unlink @eGainDev/ai-agent-sdk && npm link @eGainDev/ai-agent-sdk`
