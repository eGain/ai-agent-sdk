[@egain/ai-agent-sdk API Reference - v0.2.5-beta.0](../README.md) / AiAgentConfig
...
- [connector](AiAgentConfig.md#connector)
...
• `Optional` **connector**: [`AiAgentConnectorConfig`](AiAgentConnectorConfig.md)
