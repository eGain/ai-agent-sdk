[@egain/ai-agent-sdk API Reference - v0.2.5-beta.0](../README.md) / AiAgent
...
Disconnects chat (errors ignored), then delegates to [AuthenticationService.logout](AuthenticationService.md#logout).
