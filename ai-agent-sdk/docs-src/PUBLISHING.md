# Publishing @eGainDev/ai-agent-sdk to eGain Enterprise Registry

This guide explains how to manually publish the `@eGainDev/ai-agent-sdk` package to the eGainDev organization's GitHub Packages registry at [https://github.com/orgs/eGainDev/packages](https://github.com/orgs/eGainDev/packages).
...
The package will be published to: `https://npm.pkg.github.com/@eGainDev/ai-agent-sdk`
...
```bash
npm view @eGainDev/ai-agent-sdk versions --registry=https://npm.pkg.github.com/
```

Or check on GitHub:
- Go to [https://github.com/orgs/eGainDev/packages](https://github.com/orgs/eGainDev/packages)
- Look for `@eGainDev/ai-agent-sdk`
...
**Solution:** The package name `@eGainDev/ai-agent-sdk` uses the organization name `eGainDev` (with capital G and D). This is correct for GitHub Packages. If you see this error, verify the package name in `package.json` matches `@eGainDev/ai-agent-sdk` exactly.
